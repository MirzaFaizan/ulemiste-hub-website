                            ...
                            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                                <div className="pr-12">
                                    ...
                                    <p className="mt-4 text-lg text-blueGray-200">
                                        We create successful companies together
                                        with our clients by providing the right
                                        type of competence within tech, growth,
                                        design, and business development at the
                                        right time.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-wrap items-center mt-32">
                            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                                ...
                                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                                    let your uses guess by attaching tooltips
                                    and popoves to any element. Just make sure
                                ...
                                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-blueGray-600">
                                    ...
                                    the text and images and good to go. Just
                        ...
                        <div className="flex flex-wrap mt-12 justify-center">
                            <div className="w-full lg:w-3/12 px-4 text-center">
                                ...
                                <p className="mt-2 mb-4 text-blueGray-400">
                                    ...
                                    title and make up the bulk of the card
                                    content.
                                </p>
                            </div>
                            <div className="w-full lg:w-3/12 px-4 text-center">
                                ...
                                <p className="mt-2 mb-4 text-blueGray-400">
                                    Some quick example text to build on the card
                                    title and make up the bulk of the content.
                                </p>
                            </div>
                            <div className="w-full lg:w-3/12 px-4 text-center">
                                <div className="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
                                ...
                                <p className="mt-2 mb-4 text-blueGray-400">
                                    Some quick example text to build on the card
                                    title and make up the bulk of the s content.
                                </p>
                            </div>
                        </div>
                    </div>
